...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/kit/css/myMain.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/kit/css/all.css">

<!-- Optional JavaScript -->
<!-- jQuery first, then Popper.js, then Bootstrap JS -->
<script src="${pageContext.request.contextPath}/resource/kit/js/jquery-3.2.1.slim.min.js"></script>
<script src="${pageContext.request.contextPath}/resource/kit/popper/popper.min.js"></script>
<script src="${pageContext.request.contextPath}/resource/kit/js/bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/resource/kit/js/all.js"></script>
  ...
  <!-- 심플카드  -->
      ...
      <div class="container my-5">
      	<div class="row" style=" background: linear-gradient(to right, #ccff33, #86b300); line-height: 70px;">
      		<div  class="text-nowrap border-0 text-left pl-3" ><span class="font-weight-bold" style="font-size:1.2em;"> ${user.userName}</span></div>
			<div  class="offset-7 text-nowrap border-0 text-right small "><i class="fas fa-map-marker-alt"></i><span> ${user.userAddress}</span></div>
      	</div>
      	<div class="row" style="border:2px solid; border-top: none; border-color: #f2f2f2; background: white; line-height: 70px;">
      		<div  class="text-center col-7 my-3" style="border-right:2px solid;  border-color: #f2f2f2; line-height: 40px;" >
      			...
      			<span class="font-weight-bold" style="font-size: 2em;"><fmt:formatNumber value="${point.point}" pattern="#,###"/>P</span>
			</div>
			<div  class="text-center col-5 my-3" style="line-height: 40px;">
				<span class="font-weight-bold " style="font-size: 1.1em;">보유쿠폰</span><br>
				<span class="font-weight-bold " style="font-size: 2em;"> ${couponCount}장</span>
			</div>	
      	</div>
      </div>
...
<!-- 전체 컨테이너 끝 -->
	...
	<footer>
		<div class="jumbotron text-center jumbotron-fluid bg-secondary mt-5">
			...
			<img src="${pageContext.request.contextPath}/resource/kit/img/Kit2_size.png" />
			<div class="foo_div1">
				...
				<p>Kit.</p>
				<img src="${pageContext.request.contextPath}/resource/kit/img/kakaotalk.png">
				<img src="${pageContext.request.contextPath}/resource/kit/img/google+.png">
				<img src="${pageContext.request.contextPath}/resource/kit/img/naver.png">
			</div>
		</div>
	</footer>
