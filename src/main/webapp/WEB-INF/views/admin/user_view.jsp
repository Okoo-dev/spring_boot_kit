        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 회원 수정/삭제
				</h3>
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							...
							<form class="form-horizontal style-form" action="modify"
								method="post">
								<input type="hidden" name="userId" value="${user_view.userId}">

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원ID</label> <label
										class="col-sm-2 col-sm-2 control-label">${user_view.userId}</label>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원번호</label> <label
										class="col-sm-2 col-sm-2 control-label">${user_view.userNumber}</label>
								</div>

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원이름</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="userName"
											value="${user_view.userName}">
									</div>
								</div>


								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원연락처</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="userPhone"
											value="${user_view.userPhone}">
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원E-mail</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="userEmail"
											value="${user_view.userEmail}">
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원성별</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="userGender"
											value="${user_view.userGender}">
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원가입날짜</label> <label
										class="col-sm-2 col-sm-2 control-label">${user_view.userJoinDate}</label>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">회원계좌</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="userAccount"
											value="${user_view.userAccount}">
									</div>
								</div>

								<table>
									<tr>
										<td colspan="2"><input type="submit" value="수정" class="btn btn-round btn-success"
											> &nbsp;&nbsp;<a
											href="/admin/userlist"><button type="button"
													class="btn btn-round btn-info">목록보기</button></a> &nbsp;&nbsp; <a
											id="a-delete"
											href="${pageContext.request.contextPath}delete?userId=${user_view.userId}">
