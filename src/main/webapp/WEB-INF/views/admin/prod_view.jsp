        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 상품 정보 수정/삭제
				</h3>
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							...
							<form class="form-horizontal style-form" action="prodModify"
								method="post">
								<input type="hidden" name="prodNumber"
									value="${prod_view.prodNumber}">

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">상품 번호</label> <label
										class="col-sm-2 col-sm-2 control-label">${prod_view.prodNumber}</label>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="prodName"
											value="${prod_view.prodName}">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">입고 날짜</label> <label
										class="col-sm-2 col-sm-2 control-label">${prod_view.prodRecievingDate}</label>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="prodCookingTime"
											value="${prod_view.prodCookingTime}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="prodPrepareTime"
											value="${prod_view.prodPrepareTime}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="prodComment"
											value="${prod_view.prodComment}">
									</div>
								</div>
								...
								<table>
									<tr>
										<td colspan="2"><input type="submit" value="수정"
											...
											id="a-delete"
											href="${pageContext.request.contextPath}prodDelete?prodNumber=${prod_view.prodNumber}">
